...
public abstract class AbstractIOInstruction extends Instruction {
    ...
    protected final List<Pair<Llvm.Type, String>> parameters;
    protected final String fnName;

    protected AbstractIOInstruction(int indent, Utils.LLVMStringConstant content, String varName, List<Pair<Llvm.Type, String>> parameters, String fnName) {
        super(indent);
