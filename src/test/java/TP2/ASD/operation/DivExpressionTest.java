...
import TP2.ASD.expression.operation.DivExpression;
...
class DivExpressionTest {
    ...
    private DivExpression expression;
    ...
    void testToIR() throws TypeException {
        ...
        Instruction ins = new Div(0, leftRet.type.toLlvmType(), leftRet.result, rightRet.result, result);
